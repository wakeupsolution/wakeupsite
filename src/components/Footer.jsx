...
export default function Footer() {
  ...
  />
            ...
            <div className="flex gap-3">
              ...
              <a href="https://www.instagram.com/wakeupsolution/" className="w-10 h-10 rounded-full border border-gray-200 flex items-center justify-center text-gray-400 hover:border-purple-500 hover:bg-gradient-to-tr hover:from-purple-500 hover:to-pink-500 hover:text-white transition-all duration-300 shadow-sm hover:shadow-md">
